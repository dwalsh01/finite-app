...
const PButtonLink = styled(NavLink)<NavLinkProps>`
  ${tw`md:ml-5 rounded-full uppercase text-green-700 py-3 px-6 bg-green-200 hover:bg-green-300`}
`;

const NPButtonLink = styled(NavLink)<NavLinkProps>`
  ${tw`md:ml-5 rounded-full uppercase text-orange-700 py-3 px-6 bg-orange-300 hover:bg-orange-400`}
`;
